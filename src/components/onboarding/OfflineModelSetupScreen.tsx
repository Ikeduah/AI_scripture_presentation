...
import type { OfflineModelInfo } from "@/lib/types/smartVerses";
import { AVAILABLE_OFFLINE_MODELS } from "@/lib/types/smartVerses";
import {
  getDownloadedModelIds,
} from "@/lib/services/offlineModelService";
import {
  NATIVE_WHISPER_MODELS,
  NativeWhisperDownloadProgress,
  downloadNativeWhisperModel,
  isNativeWhisperModelDownloaded,
} from "@/lib/services/nativeWhisperModelService";
import {
  preloadOfflineModel,
  subscribeOfflineModelPreload,
  OfflineModelPreloadStatus,
} from "@/lib/services/offlineModelPreloadService";
import {
