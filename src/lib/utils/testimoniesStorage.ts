import type { FirebaseConfig, LiveTestimoniesSettings } from "@/lib/types/testimonies";
import type { SmartAutomationRule, ScheduleItemAutomation } from "@/lib/types/propresenter";
