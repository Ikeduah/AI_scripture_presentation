...
import type { KeyPoint, ParaphrasedVerse, TranscriptionSegment } from "@/lib/types/smartVerses";
import type { TranscriptionStatusUpdate } from "@/lib/types/liveSlides";
...
export type { TranscriptionStatusUpdate } from "@/lib/types/liveSlides";
