...
import { DEFAULT_DISPLAY_LAYOUT, DEFAULT_DISPLAY_SETTINGS, DEFAULT_SLIDES_LAYOUT, DISPLAY_SCRIPTURE_KEY, DISPLAY_SLIDES_KEY, DISPLAY_SETTINGS_KEY, DISPLAY_TIMER_KEY } from "@/lib/types/display";
import type { DisplayScripture, DisplaySettings, DisplaySlides, DisplayTimerState, DisplayLayoutRect, SlideLineStyle } from "@/lib/types/display";
